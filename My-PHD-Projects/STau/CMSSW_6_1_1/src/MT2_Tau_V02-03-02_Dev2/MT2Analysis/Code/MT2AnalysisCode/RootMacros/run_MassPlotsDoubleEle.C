...
//  myChannelCuts.push_back(std::string(std::string(myChan) + ".Ele1Ind >= 0"));
  ...
  //---------------Iso--------------------
  //  myChannelCuts.push_back("ele[e0Selection()].Iso04 > 0.25 && ele[e0Selection()].Iso04 < 0.5"); 
  //  myChannelCuts.push_back("ele[e1Selection()].Iso04 > 0.25 && ele[e1Selection()].Iso04 < 0.5"); 

  //  myChannelCuts.push_back("ele[e0Selection()].Iso04 < 0.1"); 
  //  myChannelCuts.push_back("ele[e1Selection()].Iso04 < 0.1"); 
...
//     tA->eeAnalysis(cuts, trigger, 100000000000000000000, "MT2-Zin-MT2gt100");
//           tA->eeZInOut(cuts, trigger, 100000000000000000000, "Ratio_CtoB-MT2lt100");
//  tA->makePlot("doubleEle[0].MT2", cuts, -10, 0, -10, trigger, "MT2-Zin-MT2gt100", 25, 0, 500, false, true, true, true,true, true, 1, true, true,"png",1);//
   ...
   //   tA->makePlot("ele[doubleEle[0].Ele1Ind].Iso04", cuts, -10, 0, -10, trigger, "Ele1-Iso04", 25, 0, 5, false, true, true, true,true, true, 1, true, true,"png",1); 
	   ...
	   //  tA->makePlot("doubleEle[0].MT2", cuts, -10, 0, -10, trigger, "MT2-e0Loose-OS-MT2gt100-noMET", 25, 0, 500, false, true, true, true,true, true, 1, true, true,"png",1);
