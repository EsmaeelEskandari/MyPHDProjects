...
public:
  ...
  //http://cmslxr.fnal.gov/lxr/source/PhysicsTools/PatUtils/interface/SmearedJetProducerT.h#209	
	...
	PFJetResolutionParam myPar = PFJetResolutionParam(GETDATALOCALPATH(JetResolutions/Spring10_PtResolution_AK5PF.txt));
...
//		  smearedJetEn = lv.E()*(1. + (smearFactor - 1.)*genMatch.E() - lv.E()/lv.E());
	  ...
	  //    (e.g. corrJetEn << rawJetEn, due to L1Fastjet corrections)
		  double rnd__ = rnd_.Gaus(0., sigmaEn);
		  	smearedJetEn = lv.E()*(1. + rnd__/lv.E());
			//cout<<" rnd_ : "<<rnd__<<endl;
		}	
	}
	//cout<<"se after corr: "<<smearedJetEn<<endl;
...
public:
  ...
  void Reset();
  Float_t BTagCSVM40eq0;
  Float_t BTagCSVM40eq1;
  Float_t BTagCSVM40eq2;
  Float_t BTagCSVM40eq3;
  Float_t BTagCSVM40ge1;
  Float_t BTagCSVM40ge2;
  Float_t BTagCSVM40ge3;
  Float_t BTagCSVM40eq0Error;
  Float_t BTagCSVM40eq1Error;
  Float_t BTagCSVM40eq2Error;
  Float_t BTagCSVM40eq3Error;
  Float_t BTagCSVM40ge1Error;
  Float_t BTagCSVM40ge2Error;
  Float_t BTagCSVM40ge3Error;
...
public:
  ...
  void SetNBJetsCSVL       (int n);
  void SetNBJetsCSVM       (int n);
  void SetNBJetsCSVT       (int n);
  void SetNBJets40CSVL     (int n);
