...
void MassPlotter::eeAnalysis(TString cuts, TString trigger, unsigned int nevents, TString myfileName){
  ...
  double bins[nbins+1] = {0, 40, 50, 65, 80, 100, 120, 150, 200, 500};
...
void MassPlotter::eeZInOut(TString cuts, TString trigger, unsigned int nevents, TString myfileName){
  ...
  double bins[nbins+1] = {40.0, 50.0 , 60.0, 80.0,  100.0};


    TH1D* in  = new TH1D("in","in", nbins, bins);
    TH1D* out_b = new TH1D("out","out", nbins, bins);
