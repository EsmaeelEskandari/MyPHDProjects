...
boost             := boost
ALL_TOOLS      += boost
boost_LOC_INCLUDE := /public/V_CMSSW64/slc5_amd64_gcc472/external/boost/1.51.0-cms2/include
...
boost_header_LOC_INCLUDE := /public/V_CMSSW64/slc5_amd64_gcc472/external/boost/1.51.0-cms2/include
...
boost_python_LOC_INCLUDE := /public/V_CMSSW64/slc5_amd64_gcc472/external/boost/1.51.0-cms2/include
...
bz2lib             := bz2lib
ALL_TOOLS      += bz2lib
bz2lib_LOC_INCLUDE := /public/V_CMSSW64/slc5_amd64_gcc472/external/bz2lib/1.0.5/include
...
cascade_headers_LOC_INCLUDE := /public/V_CMSSW64/slc5_amd64_gcc472/external/cascade/2.2.04/include
...
castor_header_LOC_INCLUDE := /public/V_CMSSW64/slc5_amd64_gcc472/external/castor/2.1.13.6-cms/include /public/V_CMSSW64/slc5_amd64_gcc472/external/castor/2.1.13.6-cms/include/shift
...
charybdis             := charybdis
ALL_TOOLS      += charybdis
charybdis_LOC_INCLUDE := /public/V_CMSSW64/slc5_amd64_gcc472/external/charybdis/1.003/include
...
classlib             := classlib
ALL_TOOLS      += classlib
classlib_LOC_INCLUDE := /public/V_CMSSW64/slc5_amd64_gcc472/external/classlib/3.1.3-cms2/include
...
clhep             := clhep
ALL_TOOLS      += clhep
clhep_LOC_INCLUDE := /public/V_CMSSW64/slc5_amd64_gcc472/external/clhep/2.1.1.0-cms2/include
...
coral_LOC_INCLUDE := /public/V_CMSSW64/slc5_amd64_gcc472/cms/coral/CORAL_2_3_21-cms10/include/LCG
coral_EX_INCLUDE  := $(coral_LOC_INCLUDE)
coral_INIT_FUNC := $$(eval $$(call ProductCommonVars,coral,,98000,coral))

cppunit             := cppunit
ALL_TOOLS      += cppunit
cppunit_LOC_INCLUDE := /public/V_CMSSW64/slc5_amd64_gcc472/external/cppunit/1.12.1/include
...
db4             := db4
ALL_TOOLS      += db4
db4_LOC_INCLUDE := /public/V_CMSSW64/slc5_amd64_gcc472/external/db4/4.4.20/include
...
evtgenlhc             := evtgenlhc
ALL_TOOLS      += evtgenlhc
evtgenlhc_LOC_INCLUDE := /public/V_CMSSW64/slc5_amd64_gcc472/external/evtgenlhc/9.1-cms2
...
expat             := expat
ALL_TOOLS      += expat
expat_LOC_INCLUDE := /public/V_CMSSW64/slc5_amd64_gcc472/external/expat/2.0.1/include
...
fastjet             := fastjet
ALL_TOOLS      += fastjet
fastjet_LOC_INCLUDE := /public/V_CMSSW64/slc5_amd64_gcc472/external/fastjet/3.0.1/include
...
fftw3             := fftw3
ALL_TOOLS      += fftw3
fftw3_LOC_INCLUDE := /public/V_CMSSW64/slc5_amd64_gcc472/external/fftw3/3.3.2/include
...
frontier_client_LOC_INCLUDE := /public/V_CMSSW64/slc5_amd64_gcc472/external/frontier_client/2.8.5-cms/include
...
gcc-cxxcompiler_LOC_FLAGS_CXXFLAGS  := -O2 -pedantic -pthread -pipe -Wno-vla -Werror=overflow -Wstrict-overflow -std=c++0x -msse3 -ftree-vectorize -Wno-strict-overflow -Werror=array-bounds -Werror=format-contains-nul -Werror=type-limits -fvisibility-inlines-hidden -fno-math-errno --param vect-max-version-for-alias-checks=50 -fipa-pta -felide-constructors -fmessage-length=0 -ftemplate-depth-300 -Wall -Wno-non-template-friend -Wno-long-long -Wreturn-type -Wunused -Wparentheses -Wno-deprecated -Werror=return-type -Werror=missing-braces -Werror=unused-value -Werror=address -Werror=format -Werror=sign-compare -Werror=write-strings -Werror=delete-non-virtual-dtor -Werror=maybe-uninitialized -Werror=strict-aliasing -Werror=narrowing -Werror=uninitialized -Werror=unused-but-set-variable -Werror=reorder -Werror=unused-variable -Werror=conversion-null -Werror=switch -fdiagnostics-show-option
...
gdbm             := gdbm
ALL_TOOLS      += gdbm
gdbm_LOC_INCLUDE := /public/V_CMSSW64/slc5_amd64_gcc472/external/gdbm/1.10/include
...
geant4vis             := geant4vis
ALL_TOOLS      += geant4vis
geant4vis_LOC_LIB := G4FR G4modeling G4RayTracer G4Tree G4visHepRep G4vis_management G4visXXX G4VRML G4GMocren G4zlib
...
hector             := hector
ALL_TOOLS      += hector
hector_LOC_INCLUDE := /public/V_CMSSW64/slc5_amd64_gcc472/external/hector/1_3_4-cms9/include
...
hepmc_headers_LOC_INCLUDE := /public/V_CMSSW64/slc5_amd64_gcc472/external/hepmc/2.06.07/include
...
heppdt             := heppdt
ALL_TOOLS      += heppdt
heppdt_LOC_INCLUDE := /public/V_CMSSW64/slc5_amd64_gcc472/external/heppdt/3.03.00/include
...
herwig             := herwig
ALL_TOOLS      += herwig
herwig_LOC_INCLUDE := /public/V_CMSSW64/slc5_amd64_gcc472/external/herwig/6.520/include
...
herwigpp             := herwigpp
ALL_TOOLS      += herwigpp
herwigpp_LOC_INCLUDE := /public/V_CMSSW64/slc5_amd64_gcc472/external/herwigpp/2.5.0/include
...
jemalloc             := jemalloc
ALL_TOOLS      += jemalloc
jemalloc_LOC_INCLUDE := /public/V_CMSSW64/slc5_amd64_gcc472/external/jemalloc/2.2.2/include
...
jimmy_headers_LOC_INCLUDE := /public/V_CMSSW64/slc5_amd64_gcc472/external/jimmy/4.2/include
...
ktjet             := ktjet
ALL_TOOLS      += ktjet
ktjet_LOC_INCLUDE := /public/V_CMSSW64/slc5_amd64_gcc472/external/ktjet/1.06-cms2/include
...
lcov             := lcov
ALL_TOOLS      += lcov
lcov_INIT_FUNC := $$(eval $$(call ProductCommonVars,lcov,,,lcov))

lhapdf             := lhapdf
ALL_TOOLS      += lhapdf
lhapdf_LOC_INCLUDE := /public/V_CMSSW64/slc5_amd64_gcc472/external/lhapdf/5.8.5/include
...
libhepml             := libhepml
ALL_TOOLS      += libhepml
libhepml_LOC_INCLUDE := /public/V_CMSSW64/slc5_amd64_gcc472/external/libhepml/0.2.1/interface
...
libjpg             := libjpg
ALL_TOOLS      += libjpg
libjpg_LOC_INCLUDE := /public/V_CMSSW64/slc5_amd64_gcc472/external/libjpg/8b/include
...
libpng             := libpng
ALL_TOOLS      += libpng
libpng_LOC_INCLUDE := /public/V_CMSSW64/slc5_amd64_gcc472/external/libpng/1.2.46/include
...
libtiff             := libtiff
ALL_TOOLS      += libtiff
libtiff_LOC_INCLUDE := /public/V_CMSSW64/slc5_amd64_gcc472/external/libtiff/3.9.4/include
...
libungif             := libungif
ALL_TOOLS      += libungif
libungif_LOC_INCLUDE := /public/V_CMSSW64/slc5_amd64_gcc472/external/libungif/4.1.4/include
...
libxml2             := libxml2
ALL_TOOLS      += libxml2
libxml2_LOC_INCLUDE := /public/V_CMSSW64/slc5_amd64_gcc472/external/libxml2/2.7.7/include/libxml2
...
llvm             := llvm
ALL_TOOLS      += llvm
llvm_LOC_INCLUDE := /public/V_CMSSW64/slc5_amd64_gcc472/external/llvm/3.2-cms2/include
...
mcdb             := mcdb
ALL_TOOLS      += mcdb
mcdb_LOC_INCLUDE := /public/V_CMSSW64/slc5_amd64_gcc472/external/mcdb/1.0.2-cms/interface
...
mctester             := mctester
ALL_TOOLS      += mctester
mctester_LOC_INCLUDE := /public/V_CMSSW64/slc5_amd64_gcc472/external/mctester/1.25.0a-cms7/include
...
meschach             := meschach
ALL_TOOLS      += meschach
meschach_LOC_INCLUDE := /public/V_CMSSW64/slc5_amd64_gcc472/external/meschach/1.2.pCMS1/include
...
mimetic             := mimetic
ALL_TOOLS      += mimetic
mimetic_LOC_INCLUDE := /public/V_CMSSW64/slc5_amd64_gcc472/external/mimetic/0.9.6/include
...
openssl             := openssl
ALL_TOOLS      += openssl
openssl_LOC_INCLUDE := /public/V_CMSSW64/slc5_amd64_gcc472/external/openssl/0.9.8e__1.0.1/include
...
oracle             := oracle
ALL_TOOLS      += oracle
oracle_LOC_INCLUDE := /public/V_CMSSW64/slc5_amd64_gcc472/external/oracle/11.2.0.3.0__10.2.0.4.0/include
...
pcre             := pcre
ALL_TOOLS      += pcre
pcre_LOC_INCLUDE := /public/V_CMSSW64/slc5_amd64_gcc472/external/pcre/7.9/include
...
photos_headers_LOC_INCLUDE := /public/V_CMSSW64/slc5_amd64_gcc472/external/photos/215.5/include
...
protobuf             := protobuf
ALL_TOOLS      += protobuf
protobuf_LOC_INCLUDE := /public/V_CMSSW64/slc5_amd64_gcc472/external/protobuf/2.4.1/include
...
pythia6_headers_LOC_INCLUDE := /public/V_CMSSW64/slc5_amd64_gcc472/external/pythia6/426/include
...
pythia8             := pythia8
ALL_TOOLS      += pythia8
pythia8_LOC_INCLUDE := /public/V_CMSSW64/slc5_amd64_gcc472/external/pythia8/165/include
...
python             := python
ALL_TOOLS      += python
python_LOC_INCLUDE := /public/V_CMSSW64/slc5_amd64_gcc472/external/python/2.7.3-cms4/include/python2.7
python_EX_INCLUDE  := $(python_LOC_INCLUDE)
python_LOC_LIB := python2.7
...
qt3support_LOC_INCLUDE := /public/V_CMSSW64/slc5_amd64_gcc472/external/qt/4.8.1/include/Qt3Support
...
qtbase             := qtbase
ALL_TOOLS      += qtbase
qtbase_LOC_INCLUDE := /public/V_CMSSW64/slc5_amd64_gcc472/external/qt/4.8.1/include /public/V_CMSSW64/slc5_amd64_gcc472/external/qt/4.8.1/include/Qt /public/V_CMSSW64/slc5_amd64_gcc472/external/qt/4.8.1/include/QtCore /public/V_CMSSW64/slc5_amd64_gcc472/external/qt/4.8.1/include/QtXml
...
qtdesigner_LOC_INCLUDE := /public/V_CMSSW64/slc5_amd64_gcc472/external/qt/4.8.1/include/QtDesigner
...
qtextra             := qtextra
ALL_TOOLS      += qtextra
qtextra_LOC_INCLUDE := /public/V_CMSSW64/slc5_amd64_gcc472/external/qt/4.8.1/include/QtScript
...
rivet             := rivet
ALL_TOOLS      += rivet
rivet_LOC_INCLUDE := /public/V_CMSSW64/slc5_amd64_gcc472/external/rivet/1.8.1/include
...
roofitcore_LOC_INCLUDE := /public/V_CMSSW64/slc5_amd64_gcc472/lcg/roofit/5.34.04-cms2/include
...
root_interface_LOC_INCLUDE := /public/V_CMSSW64/slc5_amd64_gcc472/lcg/root/5.34.03-cms4/include
...
rootrflx_LOC_FLAGS_GENREFLEX_CPPFLAGS  := -DCMS_DICT_IMPL -D_REENTRANT -DGNUSOURCE -D__STRICT_ANSI__
...
rootxml_LOC_USE := rootcore libxml2
...
self             := self
ALL_TOOLS      += self
self_LOC_INCLUDE := /home/eskandari/CMSSW_6_1_1/src /home/eskandari/CMSSW_6_1_1/include/LCG /public/V_CMSSW64/slc5_amd64_gcc472/cms/cmssw/CMSSW_6_1_1/src /public/V_CMSSW64/slc5_amd64_gcc472/cms/cmssw/CMSSW_6_1_1/include/LCG
self_EX_INCLUDE  := $(self_LOC_INCLUDE)
self_LOC_LIBDIR := /home/eskandari/CMSSW_6_1_1/lib/slc5_amd64_gcc472 /home/eskandari/CMSSW_6_1_1/external/slc5_amd64_gcc472/lib /public/V_CMSSW64/slc5_amd64_gcc472/cms/cmssw/CMSSW_6_1_1/lib/slc5_amd64_gcc472 /public/V_CMSSW64/slc5_amd64_gcc472/cms/cmssw/CMSSW_6_1_1/external/slc5_amd64_gcc472/lib
...
sherpa             := sherpa
ALL_TOOLS      += sherpa
sherpa_LOC_INCLUDE := /public/V_CMSSW64/slc5_amd64_gcc472/external/sherpa/1.4.2/include/SHERPA-MC
...
sigcpp             := sigcpp
ALL_TOOLS      += sigcpp
sigcpp_LOC_INCLUDE := /public/V_CMSSW64/slc5_amd64_gcc472/external/sigcpp/2.2.10/include/sigc++-2.0
...
tauola_headers_LOC_INCLUDE := /public/V_CMSSW64/slc5_amd64_gcc472/external/tauola/27.121.5/include
...
tauolapp             := tauolapp
ALL_TOOLS      += tauolapp
tauolapp_LOC_INCLUDE := /public/V_CMSSW64/slc5_amd64_gcc472/external/tauolapp/1.0.5/include
...
thepeg             := thepeg
ALL_TOOLS      += thepeg
thepeg_LOC_INCLUDE := /public/V_CMSSW64/slc5_amd64_gcc472/external/thepeg/1.7.0/include
...
tkonlinesw_LOC_INCLUDE := /public/V_CMSSW64/slc5_amd64_gcc472/external/tkonlinesw/2.7.0-cms4/include
...
toprex_headers_LOC_INCLUDE := /public/V_CMSSW64/slc5_amd64_gcc472/external/toprex/4.23/include
...
uuid             := uuid
ALL_TOOLS      += uuid
uuid_LOC_INCLUDE := /public/V_CMSSW64/slc5_amd64_gcc472/external/uuid/1.38-cms/include
...
vdt             := vdt
ALL_TOOLS      += vdt
vdt_LOC_INCLUDE := /public/V_CMSSW64/slc5_amd64_gcc472/cms/vdt/v0.2.3/include
...
xdaq             := xdaq
ALL_TOOLS      += xdaq
xdaq_LOC_INCLUDE := /public/V_CMSSW64/slc5_amd64_gcc472/external/xdaq/VR17173-cms2/include /public/V_CMSSW64/slc5_amd64_gcc472/external/xdaq/VR17173-cms2/include/linux
...
xerces-c             := xerces-c
ALL_TOOLS      += xerces-c
xerces-c_LOC_INCLUDE := /public/V_CMSSW64/slc5_amd64_gcc472/external/xerces-c/2.8.0-cms/include
...
xrootd             := xrootd
ALL_TOOLS      += xrootd
xrootd_LOC_INCLUDE := /public/V_CMSSW64/slc5_amd64_gcc472/external/xrootd/3.2.4-cms2/include/xrootd
...
xz             := xz
ALL_TOOLS      += xz
xz_LOC_INCLUDE := /public/V_CMSSW64/slc5_amd64_gcc472/external/xz/5.0.3-cms/include
...
zlib             := zlib
ALL_TOOLS      += zlib
zlib_LOC_INCLUDE := /public/V_CMSSW64/slc5_amd64_gcc472/external/zlib/1.2.3/include
