...
\title{A xxx Hadronic Search for Direct Stop with MT2 Variable Using full 2012 Data}
...
\abstract{A hadronic search for direct production of stops is performed on \IL of data from 
...
pdftitle={A Hadronic Search for Direct Stop with MT2 Variable Using full 2012 Data},%
pdfsubject={CMS},%
