...
void MassPlotter::TEST_QCDEstimation(TString var, TString basecut, TString upper_cut, TString lower_cut,
    ...
    for (size_t i = 0; i < fSamples.size(); ++i) {
		...
		fSamples[i].name == "QCD-HT-100To250"   //"QCD_Pt_120to170"
                || fSamples[i].name == "QCD-HT-250To500"//"QCD_Pt_170to300"
                || fSamples[i].name == "QCD-HT-500To1000"//"QCD_Pt_300to470"
                || fSamples[i].name == "QCD-HT-1000ToInf"//"QCD_Pt_470to600"
    ...
    for (int i = 0; i <= nbinsX; i++) {
        ...
        // === This is a hard coding accepted by saeid (2013-10-30) ===
        if (h_TEST_up_MT2_sub->GetBinLowEdge(i) >= 250) h_TEST_up_MT2_sub->SetBinContent(i, 0.);
        // === End of hard coding ===
    }
