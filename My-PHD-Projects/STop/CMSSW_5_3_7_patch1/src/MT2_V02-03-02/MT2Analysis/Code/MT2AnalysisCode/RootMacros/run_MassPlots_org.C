...
// 		<< " jet[6].lv.Pt() >= 60.0 "       << ")))))";
  ...
  tA->makePlot("misc.MT2",             cuts,    -1,  -1 , -10 ,   trigger , "MT2"     , 50, 0, 1000,        false,         true ,  true,   true,  true,  true, 1,1);

//  tA->makePlot("misc.MET",             cuts,    -1,  -1 , -10 ,   trigger , "MET"     , 50, 0, 1000,        false,         true ,  true,   true,  true,  true, 1);

//  tA->makePlot("misc.Vectorsumpt",             cuts,    -1,  -1 , -10 ,   trigger , "VSumPt"     , 50, 0, 1000,        false,         true ,  true,   true,  true,  true, 1);

 // tA->makePlot("misc.LeadingJPt",             cuts,    -1,  -1 , -10 ,   trigger , "LeadJPt"     , 50, 0, 1000,        false,         true ,  true,   true,  true,  true, 1);

//tA->makePlot("misc.SecondJPt",             cuts,    -1,  -1 , -10 ,   trigger , "SndJPt"     , 50, 0, 1000,        false,         true ,  true,   true,  true,  true, 1);
