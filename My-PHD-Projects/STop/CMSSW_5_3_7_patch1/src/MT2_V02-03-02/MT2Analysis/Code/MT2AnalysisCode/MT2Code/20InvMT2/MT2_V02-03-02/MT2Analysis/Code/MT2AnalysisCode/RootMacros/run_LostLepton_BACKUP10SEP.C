...
Bool_t  fMCClosure                = true; // was false by default... changed on 15 Dec
...
struct leptonicW{
	...
	double nW_scaled(){ 
		...
		if(!fTopOnly)           res +=nW*lumi*Wxsection/Wnevents+nW2*lumi*Wxsection2/Wnevents2+nW3*lumi*Wxsection3/Wnevents3+nW4*lumi*Wxsection4/Wnevents4;
		res = res / 0.99; // to take into account for PU_avg_weight , added on 14 Aug
		return res;
	}
	double nW_bg_scaled(){ 
		double res=0;
		...
		if(!fTopOnly)           res +=nW_bg*lumi*Wxsection/Wnevents+nW2_bg*lumi*Wxsection2/Wnevents2+nW3_bg*lumi*Wxsection3/Wnevents3+nW4_bg*lumi*Wxsection4/Wnevents4;
		res = res / 0.99; // to take into account for PU_avg_weight , added on 14 Aug
		return res;
	}
	double nW_leptveto_scaled(){ 
		...
		if(!fTopOnly)           res +=nW_leptveto*lumi*Wxsection/Wnevents+nW2_leptveto*lumi*Wxsection2/Wnevents2+nW3_leptveto*lumi*Wxsection3/Wnevents3+nW4_leptveto*lumi*Wxsection4/Wnevents4;
...
*/
	...
	tA->makePlot("misc.MT2"                        , ele_cuts,  -4, -1, -11 ,  trigger, "M_{T2}"     , 15, 0, 500           ,   false,   true , true,   true,  true,  false , 1);
	tA->makePlot("misc.MT2"                        , muo_cuts,  -4, -1, -13 ,  trigger, "M_{T2}"     , 15, 0, 500           ,   false,   true , true,   true,  true,  false , 1);
	...
	cout<<"--->>>"<<" Wele.QCD_bg: "<<Wele.QCD_bg<<endl;
	cout<<"--->>>"<<" Wele.Z_bg: "<<Wele.Z_bg<<endl;
	cout<<"--->>>"<<" Wele.W_bg: "<<Wele.W_bg<<endl;
	cout<<"--->>>"<<" Wele.Top_bg: "<<Wele.Top_bg<<endl;
	cout<<"--->>>"<<" Wele.Other_bg: "<<Wele.Other_bg<<endl;
	cout<<"--->>>"<<" Wmuo.QCD_bg: "<<Wmuo.QCD_bg<<endl;
	cout<<"--->>>"<<" Wmuo.Z_bg: "<<Wmuo.Z_bg<<endl;
