...
void getEfficiencies(Long64_t nevents){
	...
	if(fMakeEfficienciesPresel){
		...
		else        tA->init("samplesMineSmearedJetMETNewBTagParkedNewSamples_No7trig.dat");//samples/samplesMineSmearedJetMETNewBTag.dat");	
...
*/
	...
	tA->makePlot("misc.MT2"                        , ele_cuts,  -4, -1, -11 ,  trigger, "M_{T2}"     , /*60*/4, 125/*0*/, 1500           ,   false,   true , true,   true,  true,  false , 1);
	tA->makePlot("misc.MT2"                        , muo_cuts,  -4, -1, -13 ,  trigger, "M_{T2}"     , /*60*/4, 125/*0*/, 1500           ,   false,   true , true,   true,  true,  false , 1);
