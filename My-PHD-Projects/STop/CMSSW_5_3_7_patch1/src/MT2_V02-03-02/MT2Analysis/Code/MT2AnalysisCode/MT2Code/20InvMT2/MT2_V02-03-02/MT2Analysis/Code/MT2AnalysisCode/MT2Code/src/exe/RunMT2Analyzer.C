...
// Check arguments
	...
	//	setofcuts   ="/public/MT2Top/CutsMT2/"+setofcuts+".dat";
	if(data_PileUp.length()!=0   ){data_PileUp ="/public/MT2Top/Certification/pileUp_data/"+ data_PileUp;}
	if(mc_PileUp.length()  !=0   ){mc_PileUp   ="/public/MT2Top/Certification/pileUp_mc/"  +   mc_PileUp;}
	if(jsonFileName.length() !=0 ){jsonFileName="/public/MT2Top/Certification/JSONfiles/"  +jsonFileName;}
...
//	if(jsonFileName.length() !=0 ){jsonFileName="/shome/pnef/Projects/CMSAnalysis/MT2Analysis/Code/Certification/"            +jsonFileName;}
	if(btagFileName.length() !=0 ){btagFileName="/public/MT2Top/Efficiencies/"            + btagFileName;}
	if(htauFileName.length() !=0 ){htauFileName="/public/MT2Top/Efficiencies/"            + htauFileName;}
