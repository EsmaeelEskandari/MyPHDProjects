...
//	TH1::SetDefaultSumw2();
	...
	TH1D * f = new TH1D("f","f",2,0,2);	
        ...
        f->SetBinContent(1,0.800891);
        f->SetBinContent(2,0.810217);
        f->SetBinError(1,0.0241481);
        f->SetBinError(2,0.0272355);
...
double get_n_events(string process, bool background, bool leptveto, int sample_index = -1){
	...
	else        path = "/dataLOCAL/MT2Top/RootFiles/NewTrees20Invfb1stTry/";
